...
def write_squid_conf(sb: Sandbox, allowlist: list[str] | None, denylist: list[str] | None) -> Path:
    ...
    if allowlist is not None:
        ...
        # Default to empty allowlist for security: neither key present means no domains allowed by default
        access_rules = "http_access deny all"
        mode_comment = "# Mode: allowlist (default to empty, no domains allowed)"
